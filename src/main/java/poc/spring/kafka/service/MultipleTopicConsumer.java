...
@Service
public class MultipleTopicConsumer implements MessageConsumer {

    private static final Logger logger = LoggerFactory.getLogger(MultipleTopicConsumer.class);
